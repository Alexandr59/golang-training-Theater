...
const (
	...
	updateAccount = "UPDATE accounts SET first_name = $1, last_name = $2, phone_number = $3, email = $4 " +
		"WHERE id = $5"
	insertGenre       = "INSERT INTO genres (name) VALUES ($1)"
	...
	insertPerformance = "INSERT INTO performances (account_id, name, genre_id, duration) VALUES ($1, $2, $3, $4)"
	...
	insertPoster      = "INSERT INTO posters (account_id, schedule_id, comment) VALUES ($1, $2, $3)"
	updatePoster      = "UPDATE posters SET account_id = $1, schedule_id = $2, comment = $3 WHERE id = $4"
	insertPrice       = "INSERT INTO prices (account_id, sector_id, performance_id, price) VALUES ($1, $2, $3, $4)"
	...
	insertSchedule    = "INSERT INTO schedules (account_id, performance_id, date, hall_id) VALUES ($1, $2, $3, $4)"
